...
public class ManomotionUIManagment : MonoBehaviour
{
    ...
    [SerializeField]
    GameObject availablebackgroundModes;
    ...
    /// <summary>
    /// Shows the available background modes.
    /// </summary>
    public void ShowAvailableBackgroundModes()
    {
        availablebackgroundModes.SetActive(true);
    }
