...
public class ManomotionManager : MonoBehaviour
{
    ...
    const int STARTING_WIDTH = 320;
    const int STARTING_HEIGHT = 240;
    ...
    public bool HasReceivedAFrame
    {
        get
        {
            return hasReceivedAFrame;
        }

        set
        {
            hasReceivedAFrame = value;
        }
    }
    ...
    private bool hasReceivedAFrame;
    ...
    /// </summary>
    private void InstantiateManagerInfo()
    {
    ...
    /// <summary>
    /// Forces the permissions needed in Android.
    /// </summary>
    protected void ForcePermissionRequest()
    {
#if UNITY_ANDROID
